...
ssh root@newlyread.com "cd /home/zach/git/newly_read_core; dotnet restore; dotnet publish -o /var/newly_read_core; cp /home/zach/git/newly_read_core/bin/Debug/netcoreapp1.0/storage.db /var/newly_read_core; chmod 777 -R /var/newly_read_core; tmux attact-session -t newlyread"
